...
public class OnLineMusic {
    ...
    public String getArtisit_name(){return  artisit_name;}

    public void setArtisit_name(String album_title){this.artisit_name = artisit_name;}
}
