...
public class PermissionReq {
    ...
    private PermissionReq(Object object){mObject = object;}
    ...
    public static void onRequsetPermissionsResult(int requestCode,@NonNull String[] mPermissions,@NonNull int[] grantResults){
    ...
    private static void requestPermissions(Object object, String[] permissions,int requestCode){
        if(object instanceof Activity){
            ...
            ((	androidx.fragment.app.Fragment) object).requestPermissions(permissions,requestCode);
        }
    }
    ...
    private static int genRequestCode(){return sRequestCode.incrementAndGet();}
}
